...
/**
 * is_delim checks if char delimeter
 * @c the char to check
 ...
 * @c char input
 * return if c is alphabetic otherwise 1
 */
...
/**
 * _atoi convert str integer
 * @s str to be converted
 * return if no numbers in str 0 converted number otherwise
 */
